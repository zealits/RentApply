...
const MultiStepForm = () => {
  ...
  const validateCase2 = () => {
    ...
    step3.employers.forEach((employer, index) => {
      ...
      if (!employer.employerPhone.trim()) {
        ...
        newErrors[`employerPhone-${index}`] =
          "Employer Phone should be a 10-digit number.";
      }
  ...
  const validateCase3 = () => {
    ...
    formData.step4.financialDetails.forEach((detail, index) => {
      ...
      if (!detail.bank.trim() || !/^[A-Za-z\s]+$/.test(detail.bank)) {
        newErrors[`bank-${index}`] =
          "Bank/Institution is required and should only contain letters.";
      }
  ...
  const handleZipCodeChange = async (zipCode) => {
    setFormData((prev) => ({ ...prev, zipCode })); // Update zip code in state
    ...
    if (zipCode.length === 5) {
      ...
      try {
        ...
        const response = await axios.get(
          ...
          {
            params: {
              access_key: "3f366b09e253a0ac2a0b80d763ddf6d8", // Replace with your API key
              query: zipCode,
            },
          }
        );
        ...
        if (data) {
          ...
          console.error("No results found for the ZIP code.");
        }
      } catch (error) {
            ...
            <div className="form-row">
              ...
              <div className="form-group w-full sm:w-1/2 md:w-1/3">
                ...
                {errors.socialSecurity && (
                  <span className="error-message">{errors.socialSecurity}</span>
                )}
              </div>
                ...
                <div className="form-row">
                  <label className="form-label">
                    ...
                    <InputMask
                      ...
                      className={`form-input ${
                        errors[`employerPhone-${index}`] ? "input-error" : ""
                      }`}
              ...
              <div key={index} className="financial-detail-row">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailChange(index, "balance", e.target.value)
                    }
                    onKeyDown={(e) => {
                ...
                {detail.type === "Credit Card" && (
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className={`form-input ${
                        errors[`creditCardNumber-${index}`] ? "input-error" : ""
                      }`}
                    />
                ...
                {detail.type === "Auto Loan" && (
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleDetailChange(index, "loanAmount", e.target.value)
                      }
                      className={`form-input ${
                        errors[`loanAmount-${index}`] ? "input-error" : ""
                      }`}
                    />
